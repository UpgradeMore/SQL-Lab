    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="card shadow mb-4" style="margin-left: 15px;margin-right: 15px;margin-top: 20px;">
                ...
                <div class="card-body" style="background-color: #131417;">
                    Write a query to update salary of <b>aman</b> to <b>15000</b>.
                <br><br>
                Example:
                <ul>
                <li>UPDATE table_name SET column_name = value WHERE column_name= value;</li>
                </ul>
                </div>
            </div>
						...
						<div class="collapse" id="panel-1">
							<div class="pt-3">
								<p class="mb-0" style="color: #fff;">
                                    <ul>
                                    <li>UPDATE user SET salary=15000 WHERE FirstName="aman"</li>
                                    </ul>
                                </p>
							</div>
						</div>
        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-color: #000;">
            ...
            <div id="content">
                ...
                <html> 
<iframe width="80%" height="80%" src="terminal-8.php" frameborder="yes" scrolling="yes" name="myIframe" id="myIframe" style="margin-left: 90px;"> </iframe>
