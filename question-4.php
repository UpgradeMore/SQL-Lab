    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="card card-sm card-body rounded mb-3" style="margin-right: 15px;margin-left: 15px;padding: 10px;background-color: #9936f3;"> 
              ...
              <div class="container" style="margin-top: 25px;">
                <div class="row">
                  <div class="col-sm">
                    <button type="button" class="btn btn-primary custom"><a href="question-3.php" style="color: #fff; text-decoration: none;"><b>Back</b></a></button>
                  </div>
                  <div class="col-sm">
        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-color: #000;">
            ...
            <div id="content">
                ...
                <html> 
<iframe width="80%" height="80%" src="terminal-4.php" frameborder="yes" scrolling="yes" name="myIframe" id="myIframe" style="margin-left: 90px;"> </iframe>
