    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="card shadow mb-4" style="margin-left: 15px;margin-right: 15px;margin-top: 20px;">
                ...
                <br><br>
                You can search on the Internet for SQL commands.
                Example:
                <ul>
                <li>how to check current user in SQL.</li>
                <li>How to check server hostname in SQL.</li>
                </ul>
                </div>
            </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-color: #000;">
            ...
            <div id="content">
                ...
                <div class="sidebar-heading" style="font-size: 35px;color: #fff;">
                            <b style="margin-left: 200px;">Basic SQL Commands Lab</b>
                </div>
